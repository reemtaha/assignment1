...
%Last hypothesis of assignment 1 using the last 3 features with the same
...
U1=T{1:m_60,19:21};  %3 selected features
U2=U.^2;
...
Unew=T{m_60+1:m_60+m_20, 4:18};

U1new=T{m_60+1:m_60+m_20, 19:21};  %3 selected features
U2new=Unew.^2;
...
Unewest=T{m_last:end, 4:18};
U1newest=T{m_last:end, 19:21};  %3 selected features
U2newest=Unewest.^2;
