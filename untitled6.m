...
%Fourth hypothesis of assignment 1 using the next 3 features with the same
...
U0=T{1:m_60,2};
U=T{1:m_60, [4:12 16:21]};

U1=T{1:m_60,13:15};  %3 selected features
U2=U.^2;
...
Unew=T{m_60+1:m_60+m_20,[4:12 16:21]};

U1new=T{m_60+1:m_60+m_20, 13:15};  %3 selected features
U2new=Unew.^2;
...
Unewest=T{m_last:end, [4:12 16:21]};
U1newest=T{m_last:end, 13:15};  %3 selected features
U2newest=Unewest.^2;
