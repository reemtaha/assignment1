...
%Third hypothesis of assignment 1 using the next 3 features with the same
...
U0=T{1:m_60,2};
U=T{1:m_60, [4:9 13:21]};

U1=T{1:m_60,10:12};  %3 selected features
U2=U.^2;
...
Unew=T{m_60+1:m_60+m_20,[4:9 13:21]};

U1new=T{m_60+1:m_60+m_20, 10:12};  %3 selected features
U2new=Unew.^2;
...
Unewest=T{m_last:end, [4:9 13:21]};
U1newest=T{m_last:end, 10:12};  %3 selected features
U2newest=Unewest.^2;
